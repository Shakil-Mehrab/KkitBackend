...
<div class="mt-2">
  ...
  <form action="{{url('admin/store/contact')}}" method="post" encetype="maltipart/form-data">
   @csrf 
     <div class="row">
     ...
     <div class="form_group {{ $errors->has('slug') ? 'has erros' : ''}} col-lg-6 col-md-6 col-sm-12">
        ...
        <input type="text" class="form-control" name="slug" id="slug" placeholder="contact slug" value="{{Request::old('slug')}}">
        @if ($errors->has('slug'))
        <span class="help-block">
      ...
      <div class="form_group {{ $errors->has('price') ? 'has erros' : ''}} col-lg-6 col-md-6 col-sm-12">
        ...
        <input type="text" class="form-control" name="price" id="price" placeholder="price" value="{{Request::old('price')}}">
        @if ($errors->has('price'))
        <span class="help-block">
